...
{
    private readonly byte[] _buffer = new byte[Constants.PACKET_BUFFER_SIZE];

    private readonly int _bufferSize = Constants.PACKET_BUFFER_SIZE;
    private readonly int _headerSize = Constants.HEADER_SIZE;
