...
public class ProcessChannelBenchmark
{
    ...
    private ProcessChannel<ReceivedContext> _channel = null!;  // 채널을 필드로 이동
    ...
    public void Setup()
    {
        ...
        _processedCount = 0;
        _channel = new(_loggerFactory, OnProcess);
    }
    ...
    public async Task ProcessMessages_SimpleWork()
    {
        ...
        {
            await _channel.EnqueueAsync(new ReceivedContext($"session_{i}", PacketType.Ping, _testData, null));
        }
