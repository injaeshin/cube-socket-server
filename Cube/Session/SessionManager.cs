...
public abstract class SessionManager<T>(ILoggerFactory loggerFactory, SessionHeartbeat heartbeatMonitor) : ISessionManager, ISessionCreator where T : INetSession, INetSessionTransport
{
