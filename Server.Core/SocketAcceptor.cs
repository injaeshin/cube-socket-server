...
public class SocketAcceptor
{
    ...
    public SocketAcceptor(ILogger<SocketAcceptor> logger, Func<Socket, Task> onConnected)
    {
        ...
        _listenSocket.Bind(new IPEndPoint(IPAddress.Any, Constants.PORT));
        _listenSocket.Listen(Constants.MAX_CONNECTION);
    }

    public async Task Begin()
    {
        _logger.LogInformation("소켓 서버 시작 (포트: {Port})", Constants.PORT);
